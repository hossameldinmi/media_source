  ...
  group('MediaSource', () {
    group('properties', () {
      test('should have correct basic properties', () {
        ...
        expect(source.mimeType, equals('image/png'));
        expect(source.size, equals(4));
    ...
    group('thumbnailOrNull', () {
      test('should return thumbnail when available', () {
        ...
        expect(source.thumbnailOrNull(), equals(thumbnail));
      });
    ...
    group('when pattern', () {
      ...
      test('should pass correct source to callback', () {
        ...
        final result = source.when<String>(
          memory: (memory) => memory.name,
          orElse: () => 'unknown',
        );

        expect(result, equals('video.mp4'));
      });
      ...
      test('should support different return types', () {
        ...
        final intResult = source.when<int>(
          memory: (memory) => 42,
          orElse: () => 0,
        );

        final boolResult = source.when<bool>(
          memory: (memory) => true,
          orElse: () => false,
        );
